...
public class VehicleInfo implements Serializable {
    public static class ContactInfo implements Serializable {
        ...
        public ContactInfo(final String name, final String phoneNumber, final String url) {
            this.name = name;
        ...
        public boolean equals(final Object other) {
            ...
            return phoneNumber.equals(otherModel.phoneNumber)
                && url.equals(otherModel.url)
