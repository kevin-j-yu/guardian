...
public interface MapDependencyFactory {
    Fragment getMapFragment();

    LocationAutocompleteInteractor getAutocompleteInteractor(final Context context);

    GeocodeInteractor getGeocodeInteractor(final Context context);
}
