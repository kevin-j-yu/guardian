...
public class MainFragment extends Fragment implements BackPropagator {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater,
        ...
        getChildFragmentManager().beginTransaction()
            .replace(R.id.map_fragment_container, RiderDependencyRegistry.mapDependencyFactory().getMapFragment())
            .commit();
        return view;
    }
    ...
    public void propagateBackSignal() {
        mainCoordinator.propagateBackSignal();
    }
}
