 ...
 */
package ai.rideos.android.example_rider_app;
...
public class ExampleRiderApplication extends BaseApplication {
    @Override
    protected void registerDependencies() {
        final String gmsKey = new MetadataReader(getApplicationContext())
            .getStringMetadata(GoogleMetadataKeys.GMS_API_KEY)
            .getOrThrow();
        RiderDependencyRegistry.init(new GoogleMapDependencyFactory(getApplicationContext(), gmsKey));
    }
}
